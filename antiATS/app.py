...
# Aplicar estilo (agora com cores_site definido)
...
def carregar_segredos():
    ...
    # Se não encontrou nada (isto ainda DENTRO da função)
    st.error("""
    ...
    **Para Streamlit Cloud:**
    ...
    """)
    st.stop()  # ← Isto também DENTRO da função (mesma indentação)

# ← Agora sim a função terminou

# Carregar configurações
config = carregar_segredos()  # ← Agora a função existe!
...
# Botão de voltar (agora com cores_site definido)
st.markdown(
    f"""
